    ...
    <section className="container">
      <div className={styles.features}>
        <div className={styles.feature}>
          ...
          <h4>{i18n.t('services.services1.title')}</h4>
          <p>{i18n.t('services.services1.description')}</p>
        </div>
        <div className={styles.feature}>
          <div>
            <svg
          ...
          <h4>{i18n.t('services.services2.title')}</h4>
          <p>{i18n.t('services.services2.description')}</p>
        </div>
        <div className={styles.feature}>
          <div>
            <svg
          ...
          <h4>{i18n.t('services.services3.title')}</h4>
          <p>{i18n.t('services.services3.description')}</p>
        </div>
      </div>
    </section>
  );
