...
import FooterStoresImages from './FooterStoresImages';
import i18n from '../../LanguageConfig';
function Footer() {
  return (
    <footer dir={i18n.t('dir')} className={styles.footer}>
      <div className="container">
        <div className={styles.footerContainer}>
          <div className={styles.footerNav}>
            <Link to="/">Exclusive</Link>
            <Link>{i18n.t('footer.subscribe')}</Link>
          ...
          <div className={styles.footerNav}>
            ...
            <Link to="/">{i18n.t('footer.shop')}</Link>
          </div>
          <div className={styles.footerNav}>
            <h4>{i18n.t('footer.quickLinks')}</h4>
            <Link>{i18n.t('footer.privacy')}</Link>
            <Link>{i18n.t('footer.usage')}</Link>
            <Link>{i18n.t('footer.FAQ')}</Link>
            <Link>{i18n.t('footer.contact')}</Link>
          </div>
          <div className={styles.footerNav}>
            <h4>{i18n.t('footer.downloadApp')}</h4>
            ...
            <div className={styles.social}>
              ...
              <Link>
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <g clipPath="url(#clip0_3427_4514)">
                    <path
