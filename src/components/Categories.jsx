...
function Categories() {
  ...
  const productWidth = 170; // Adjust as needed

  const scrollToNext = () => {
    containerRef.current.scrollLeft += productWidth;
  };
  ...
  return (
    <section className="container">
      <ProductTitle
        ...
        onScrollToPrevious={scrollToPrevious}
      >
        <div className={styles.productTitleText}>
          <p className={styles.productSubTitle}>{i18n.t('category.subTitle')}</p>
          <h2 className={styles.productMainTitle}>{i18n.t('category.title')}</h2>
        </div>
      </ProductTitle>
      <div className={styles.productSlider}>
        <div ref={containerRef} className={styles.productSliderContainer}>
          <div className={styles.category}>
            ...
            <h4>{i18n.t('category.categories.phones')}</h4>
          </div>
          <div className={styles.category}>
            <div>
              <svg
              ...
              >
                ...
                <defs>
                  <clipPath id="clip0_3038_613">
                    <rect width="56" height="56" fill="white" />
                  </clipPath>
                </defs>
              </svg>
            </div>
            <h4>{i18n.t('category.categories.computers')}</h4>
          </div>
          <div className={styles.category}>
            <div>
              <svg
              ...
              >
                ...
                <defs>
                  <clipPath id="clip0_3038_629">
                    <rect width="56" height="56" fill="white" />
                  </clipPath>
                </defs>
              </svg>
            </div>
            <h4>{i18n.t('category.categories.smartwatch')}</h4>
          </div>
          <div className={styles.category}>
            <div>
              <svg
              ...
              >
                ...
                <defs>
                  <clipPath id="#clip0_3038_6">
                    <rect width="56" height="56" fill="white" />
                  </clipPath>
                </defs>
              </svg>
            </div>
            <h4>{i18n.t('category.categories.camera')}</h4>
          </div>
          <div className={styles.category}>
            <div>
              <svg
              ...
              >
                ...
                <defs>
                  <clipPath id="clip0_3038_644">
                    <rect width="56" height="56" fill="white" />
                  </clipPath>
                </defs>
              </svg>
            </div>
            <h4>{i18n.t('category.categories.headphones')}</h4>
          </div>
          <div className={styles.category}>
            <div>
              <svg
              ...
              >
                ...
                <defs>
                  <clipPath id="clip0_3038_809">
                    <rect width="56" height="56" fill="white" />
                  </clipPath>
                </defs>
              </svg>
            </div>
            <h4>{i18n.t('category.categories.gaming')}</h4>
          </div>
          <div className={styles.category}>
            <div>
              <svg
            ...
            <h4>{i18n.t('category.categories.playStation')}</h4>
          </div>
          <div className={styles.category}>
            <div>
              <svg
            ...
            <h4>{i18n.t('category.categories.device')}</h4>
          </div>
        </div>
      </div>
