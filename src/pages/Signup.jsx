...
function Signup() {
  ...
  const [emailEntered, setEmailEntered] = useState(false); // State to track email input
        ...
        <form className={styles.signUpForm} onSubmit={handleSubmit}>
          ...
          {emailEntered && (
            <p className={styles.verificationMessage}>
              {language === 'en'
                ? 'An email verification link will be sent to this email address.'
                : 'سيتم إرسال رابط التحقق إلى عنوان البريد الإلكتروني هذا.'}
            </p>
          )}
          <input
            type="password"
